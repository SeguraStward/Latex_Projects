...
SCENES=("S01_Portada" "S02_Introduccion" "S03b_ANN" "S03c_IntroCNN" "S04_CapasCNN" "S05_ImageNet_CAD" "S05b_TransferLearning" "S06_Arquitecturas" "S07_Metricas" "S08_Aplicaciones" "S09_Limitaciones" "S10_Conclusiones")
...
rm -f concat.txt
for dir in s01_portada s02_introduccion s03b_ann s03c_intro_cnn s04_capas_cnn s05_imagenet_cad s05b_transfer_learning s06_arquitecturas s07_metricas s08_aplicaciones s09_limitaciones s10_conclusiones; do
